    ...
    companion object {
        ...
        private fun randomByte(rng: WorldEntropy): World {
            return FloorPlan.binary.world().apply {
                setBeepers(0, rng.nextInt(256).shl(2).toLong())
                setKarel(9, 0, WEST)
            }
        }
        ...
        private fun randomBytes(rng: WorldEntropy, direction: Int): World {
            return FloorPlan.binary.world().apply {
                setBeepers(0, (rng.nextInt(256).shl(2) + rng.nextInt(256).shl(12)).toLong())
        ...
        val mowTheLawn = Problem(
            ...
            FloorPlan.empty.world().apply {
                setBeepers(0x3f0fL, 0xc3f0fc3f0fcL.shl(20))
                setKarel(1, 7, EAST)
            }
        }
        ...
        val harvestTheField = Problem(
            ...
            FloorPlan.empty.world().apply {
                setBeepers(0x805L, 0x2a1542a05008000L)
                setKarel(5, 7, NORTH)
            }
        }
        ...
        val cleanTheRoom = Problem(
            ...
            FloorPlan.empty.world().apply {
                setBeepers(Random.nextLong(), Random.nextLong())
                setKarel(0, 9, EAST)
            }
        }
        ...
        val followTheSeeds = Problem(
            ...
            FloorPlan.empty.world().apply {
                setBeepers(0xffc017f50L, 0x55d5555157d405ffL)
                setKarel(5, 4, WEST)
            }
        }
        ...
        val solveTheMaze = Problem(
            ...
            builder.world().apply {
                ...
                fun generateMaze() {
                    ...
                    repeat(4) {
                        if (beeperAhead()) {
                            builder.tearDownWall(position, direction)
                            moveForward()
                            generateMaze()
                            turnAround()
                            builder.tearDownWall(position, direction)
